...
Impact graph snapshots carry schema metadata and are migrated on read; reindex to persist upgrades.
...
- `POST /v1/index/rebuild` — rebuild the repo index (optional `libs_sources`).
