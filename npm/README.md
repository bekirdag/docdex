...
- Platform diagnostics (no download): `docdex doctor` prints detected OS/arch(/libc), whether supported, and the expected Rust target triple + release asset naming pattern.
