...
pub use registry::{
    ...
    resolve_shared_state_key, resolve_shared_state_key_lenient, split_scoped_state_dir, RepoHandle,
    RepoHandleManager, RepoIdentityError, RepoInspectReport, RepoReassociateResult,
};
